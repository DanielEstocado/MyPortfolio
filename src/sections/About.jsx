...
const About = () => {
  return (
    <section>
      <div className='bg-base-300 shadow-xl lg:pt-24 lg:pb-20 py-18 lg:my-15 lg:border-y dark:border-neutral-500 border-gray-400 max-w-6xl mx-auto lg:rounded-2xl'>
