    ...
    <section>
      <div className=" py-18 lg:rounded-4xl bg-base-200 shadow-xl lg:border dark:border-neutral-500 border-gray-400">
        ...
        <section className="mb-10  flex flex-col gap-10">
          <h2 className="padding-x uppercase font-montserrat font-bold text-2xl title-gradient">
            Dev Stack
          </h2>
        ...
        <section className="lg:flex gap-10 padding-x">
          <div className="flex-1 min-w-0">
            <h2 className="uppercase font-montserrat font-bold text-2xl my-6 title-gradient">
              Education
            </h2>
            <EducationTimeline />
          </div>
          ...
          <div className="flex-1 min-w-0">
            <h2 className="uppercase font-montserrat font-bold text-2xl my-6 title-gradient lg:text-start">
              Work
            </h2>
            <WorkTimeline />
          </div>
