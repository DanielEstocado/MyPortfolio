      ...
      <div className="navbar bg-base-100 lg:bg-transparent px-10">
         <div className="navbar-start">
            <div className="dropdown">
               <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden mr-3 border-0 ">
         ...
         <div className="navbar-end ">
            ...
            <input
               ...
               defaultChecked={document.documentElement.getAttribute('data-theme') !== 'forest'}
               onChange={(e) => {
                  document.documentElement.setAttribute('data-theme', e.target.checked ? 'nord' : 'forest');
               }}
               />
